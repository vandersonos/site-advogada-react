    ...
    render() {
        ...
        return (
            <div className="col-12 bg-transparent ">
                <div id={this.props.id} className="bg-transparent">
                    <div className="mt-4 px-4 mb-5 py-4">
                        <div className="flex flex-col sm:flex-row">

                            <form className="w-96  form-contato">
                                <div className="col-12">
                                    <h5 className="valign-wrapper">Contato</h5>
                                </div>
                                <div className="flex flex-col sm:flex-row place-content-between m-2">
                                ...
                                <div className="flex flex-col sm:flex-row place-content-between m-2">
                                    ...
                                    <textarea id="mensagem" className="form-control w-100 h-20"></textarea>
                                </div>

                            </form>

                            <div className="flex flex-col items-center form-contato-acoes  p-2 w-46">

                                <div className='flex space-x-4 box-whatsapp mt-2 mb-2 sm:mt-5 sm:mb-5'>
                                ...
                                <div className='row'>
                                    ...
                                    <div className="col-12 form-title-pagina-facebook">
                                        <h6 className="valign-wrapper">Ou acesse minha <br></br>página no facebook</h6>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="col-12">
                                        <div className='flex space-x-4 mt-2 mb-2 sm:mt-5 sm:mb-5'>
                                            <div className='col-3'>
